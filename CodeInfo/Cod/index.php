				...
				<!-- One -->
					<section id="one" class="wrapper style1 special">
						<div class="inner">
							<header class="major">
								<h2>¿Cómo funciona?</h2>
<p>Es una plataforma que nos muestra las competencias educativas y demás información <br /> realacionada de los estudiantes de las
								diferentes instituciones miembros de nuestra plataforma </p>
								<p>Nuestra plataforma cuenta con una amplia base de datos gracias a nuestros convenios<br />
								con las diferentes universidades del país, por esta misma razón se garantiza que toda<br /> la información presentada sea veraz, creando así<br /> una red transparente de datos.</p>
							</header>
				...
				<!-- Footer -->
					<footer id="footer">
						...
						<ul class="copyright">
							<li>&copy; HU-Capital</li><li>Design: <a href="#">ZTR</a></li>
						</ul>
					</footer>
...
>>>>>>> 0f350abc5b0add16847ae955ede7ea290862246d:CodeInfo/Cod/index.php
